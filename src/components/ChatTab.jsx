...
export default function ChatTab() {
  ...
  const [messages, setMessages] = useState([
    ...
    },
    {
      id: 'm2',
      sender: 'Eu',
      text: 'Entendido. Já verifiquei os prazos de pagamento e metas de sell-in. Atualizei os termos na aba de Acordos.',
      time: '11:43',
      isMe: true,
    },
    {
      id: 'm3',
      sender: 'K9',
      text: 'Ótimo. Conferi a margem líquida de balcão e está acima dos 34%. Pode prosseguir com o aceite.',
      time: '11:44',
      isMe: false,
    },
    {
      id: 'm4',
      sender: 'K9',
      text: 'Canal seguro ativo. Vamos manter todos os acordos comerciais registrados por aqui.',
      time: '11:44',
      isMe: false,
    },
  ]);
